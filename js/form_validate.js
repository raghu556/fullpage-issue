...
{
	var form_type = '';
	var firstName = $("#payments-firstname").val();
	var lastName = $("#payments-lastname").val();
	var email = $("#email").val();
	var company = $("#company").val();
	var Phone = $("#phoneNumber").val();
	var requestType = $(".bootstrap-select button.dropdown-toggle").attr("title");
	var requestDetails = $("#comment").val();
	var sourcePage = '';
	var collateral = '';


	params =  "form_type="+form_type+"&firstName="+firstName+"&lastName="+lastName+"&email="+email+"&company="+company+"&sPhone="+Phone+"&requestDetails="+requestDetails+"&sourcePage="+sourcePage+"&Collateral="+collateral+"&requestType="+requestType;
